...
public abstract partial class EbnfParser {
	...
	static EbnfParser() {
		...
		var _Element = Patterns.Memoize(Patterns.Bind<EbnfParser.Element>(Patterns.TupleLooseSequence(new[] { typeof((string, string)), typeof(EbnfParser), typeof(string)  }, Patterns.IgnoreLeadingWhitespace(Patterns.Optional(Patterns.TupleLooseSequence(new[] { typeof(string), typeof(string)  }, Patterns.With<EbnfParser.Element>((x, d) => x.Name = d, _ElementIdentifier), Patterns.IgnoreLeadingWhitespace(Patterns.Literal(":"))))), Patterns.With<EbnfParser.Element>((x, d) => x.Body = d, Patterns.IgnoreLeadingWhitespace(Patterns.Choice(_Group, _Optional, _RuleReference, _StringLiteral, _RegexLiteral, _End))), Patterns.With<EbnfParser.Element>((x, d) => x.Modifiers = d, Patterns.IgnoreLeadingWhitespace(Patterns.Optional(Patterns.IgnoreLeadingWhitespace(Patterns.Choice(Patterns.IgnoreLeadingWhitespace(Patterns.Literal("*")), Patterns.IgnoreLeadingWhitespace(Patterns.Literal("+"))))))))));

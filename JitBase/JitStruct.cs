...
public abstract class IStructRef<T> where T : IJitStruct {
	...
	public abstract IRuntimeValue<U> GetFieldElement<U>(ulong offset, int index) where U : struct;
	public abstract IRuntimeValue<U> GetFieldElement<U>(ulong offset, IRuntimeValue<int> index) where U : struct;
	public abstract void SetFieldElement<U>(ulong offset, int index, IRuntimeValue<U> value) where U : struct;

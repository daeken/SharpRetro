...
public abstract class IRuntimeValue<T> where T : struct {
	...
	public abstract IRuntimeValue<ulong> VectorSumUnsigned(byte esize, byte count);
	public abstract IRuntimeValue<Vector128<float>> VectorCountBits(IRuntimeValue<long> elems);
	public abstract IRuntimeValue<Vector128<float>> VectorExtract(IRuntimeValue<Vector128<float>> _b, uint Q, uint _index);
	public abstract IRuntimeValue<Vector128<float>> VectorFrsqrte(int bits, int elements);

...
impl Builder for RecordingBuilder {
    ...
    fn vishi(&mut self, a: u32, ew: u32, c: u32, d: u32) -> u32 {
        self.v(format!("vishi[{d}] v{a} @{ew}b #{c}"))
    }
    fn vmovmsk(&mut self, a: u32, ew: u32) -> u32 { self.v(format!("vmovmsk v{a} @{ew}b")) }
    fn vfun(&mut self, a: u32, ew: u32, op: u32) -> u32 { self.v(format!("vfun[{op}] v{a} @{ew}b")) }
    fn vfminmax(&mut self, a: u32, b: u32, ew: u32, m: bool) -> u32 {
        self.v(format!("vf{} v{a} v{b} @{ew}b", if m {"max"} else {"min"}))
    }
    fn vfcmpp(&mut self, a: u32, b: u32, ew: u32, p: u32) -> u32 {
        self.v(format!("vfcmpp[{p}] v{a} v{b} @{ew}b"))
    }
    ...
    fn loop_while(&mut self, n: u32, exit_on: bool, body: &mut dyn FnMut(&mut Self) -> u32) -> u32 {
        ...
        let f = body(self);
        self.stmt(format!("}} flag=v{f}"));
        self.v(format!("loop_while_rem v{n}"))
    }

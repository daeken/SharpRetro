...
public static class Extensions {
    extension(List<StaticIRStatement> stmts) {
        ...
        public List<StaticIRStatement> TransformValues(Func<StaticIRValue, StaticIRValue> valueFunc) =>
            ((StaticIRStatement.Body) new StaticIRStatement.Body(stmts).TransformValues(valueFunc)).Stmts;
    }
}
...
public static class Extensions {
    ...
    public static dynamic AsNonBool(this object value) => value is bool b ? b ? 1UL : 0UL : value;
    ...
    public static dynamic WithCommonType(this (dynamic A, dynamic B) values, Func<dynamic, dynamic, dynamic> func) {
        ...
        if(a.GetType() == b.GetType())
            return func(a, b);
        if((a is double && b is not double) || (b is double && a is not double))
            return func((double) a, (double) b);
        if((a is float && b is not float) || (b is float && a is not float))

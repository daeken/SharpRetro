    ...
    public bool Interpret(uint insn, uint pc) {
		...
		if((insn & 0xFC00003F) == 0x0000001A) {
			...
			if((bool) (((uint) (rtv)) == ((uint) ((byte) ((byte) 0x0))))) {
				...
				if((bool) (((byte) ((byte) ((((sbyte) ((sbyte) (((bool) ((bool) (((uint) (rsv)) == ((uint) (0x80000000U))))) ? 1U : 0U))) & ((sbyte) ((sbyte) (((bool) ((bool) (((uint) (rtv)) == ((uint) (0xFFFFFFFFU))))) ? 1U : 0U))))))) != ((byte) ((byte) 0x0)))) {
		...
		if((insn & 0xFC000000) == 0x88000000) {
			...
			var ert = temp_31;
			State->LdWhich = (uint) (rt);
			State->LdValue = (uint) ((uint) ((uint) ((((uint) (addr)) & ((uint) ((uint) ((byte) ((byte) 0x3)))))) switch { (uint) ((byte) 0x0) => (uint) ((((uint) ((uint) ((((uint) (ert)) & ((uint) (0xFFFFFFU)))))) | ((uint) ((uint) (((uint) ((uint) ((byte) (ReadMemory<byte>(raddr))))) << (int) ((byte) 0x18)))))), (uint) ((byte) 0x1) => (uint) ((((uint) ((uint) ((((uint) (ert)) & ((uint) ((uint) ((ushort) ((ushort) 0xFFFF)))))))) | ((uint) ((uint) (((uint) ((uint) ((ushort) (ReadMemory<ushort>(raddr))))) << (int) ((byte) 0x10)))))), (uint) ((byte) 0x2) => (uint) ((((uint) ((uint) ((((uint) (ert)) & ((uint) ((uint) ((byte) ((byte) 0xFF)))))))) | ((uint) ((uint) (((uint) (ReadMemory<uint>(raddr))) << (int) ((byte) 0x8)))))), _ => (uint) (ReadMemory<uint>(raddr)) }));
			return true;
		}
		insn_31:
		/* LWR */
		if((insn & 0xFC000000) == 0x98000000) {
			...
			var ert = temp_33;
			State->LdWhich = (uint) (rt);
			State->LdValue = (uint) ((uint) ((uint) ((((uint) (addr)) & ((uint) ((uint) ((byte) ((byte) 0x3)))))) switch { (uint) ((byte) 0x0) => (uint) (ReadMemory<uint>(raddr)), (uint) ((byte) 0x1) => (uint) ((((uint) ((uint) ((((uint) (ert)) & ((uint) (0xFF000000U)))))) | ((uint) ((uint) ((((uint) ((uint) (ReadMemory<uint>(addr)))) & ((uint) (0xFFFFFFU)))))))), (uint) ((byte) 0x2) => (uint) ((((uint) ((uint) ((((uint) (ert)) & ((uint) (0xFFFF0000U)))))) | ((uint) ((uint) ((ushort) ((ushort) (ReadMemory<ushort>(addr)))))))), _ => (uint) ((((uint) ((uint) ((((uint) (ert)) & ((uint) (0xFFFFFF00U)))))) | ((uint) ((uint) ((byte) ((byte) (ReadMemory<byte>(addr)))))))) }));
			return true;
		}
		insn_32:
		/* LWC2 */

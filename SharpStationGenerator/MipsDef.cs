...
public class MipsDef : Def {
	...
	MipsDef(string name, int size, Dictionary<int, (byte Mask, byte Match)> matchBytes, 
	...
	public static MipsDef Parse(PList def) {
		...
		return new MipsDef(name, bitstr.Length / 8, matchBytes, fields, disasm, decode, eval, locals);
	}
}
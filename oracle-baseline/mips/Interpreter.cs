...
public unsafe partial class Interpreter {
    public bool Interpret(uint insn, uint pc) {
		...
		if((insn & 0xFC00003F) == 0x00000020) {
			...
			if((bool) (((uint) ((uint) (((((uint) ((uint) (~((uint) ((((uint) (lhs)) ^ ((uint) (rhs)))))))) & ((uint) ((uint) ((((uint) (lhs)) ^ ((uint) (r))))))) & ((uint) (0x80000000U)))))) != ((uint) (0x0U)))) {
				throw new CpuException(ExceptionType.OV, pc, insn);
			}
			var temp_83 = rd;
			if(temp_83 != 0)
				State->Registers[temp_83] = (uint) (((uint) (uint) ((uint) (lhs))) + ((uint) (uint) ((uint) (rhs))));
			return true;
		}
		insn_1:
		/* ADDI */
		if((insn & 0xFC000000) == 0x20000000) {
			...
			if((bool) (((uint) ((uint) (((((uint) ((uint) (~((uint) ((((uint) (lhs)) ^ ((uint) (eimm)))))))) & ((uint) ((uint) ((((uint) (lhs)) ^ ((uint) (r))))))) & ((uint) (0x80000000U)))))) != ((uint) (0x0U)))) {
				throw new CpuException(ExceptionType.OV, pc, insn);
			}
			var temp_85 = rt;
			if(temp_85 != 0)
				State->Registers[temp_85] = (uint) (((uint) (uint) ((uint) (lhs))) + ((uint) (uint) ((uint) (eimm))));
			return true;
		}
		insn_2:
		/* ADDIU */
		if((insn & 0xFC000000) == 0x24000000) {
			...
			var temp_87 = rt;
			if(temp_87 != 0)
				State->Registers[temp_87] = (uint) (((uint) (uint) ((uint) (temp_3))) + ((uint) (uint) ((uint) (eimm))));
			return true;
		}
		insn_3:
		/* ADDU */
		if((insn & 0xFC00003F) == 0x00000021) {
			...
			var temp_90 = rd;
			if(temp_90 != 0)
				State->Registers[temp_90] = (uint) (((uint) (uint) ((uint) (temp_4))) + ((uint) (uint) ((uint) (temp_5))));
			return true;
		}
		insn_4:
		/* AND */
		if((insn & 0xFC00003F) == 0x00000024) {
			...
			var temp_93 = rd;
			if(temp_93 != 0)
				State->Registers[temp_93] = (uint) ((((uint) (temp_6)) & ((uint) (temp_7))));
			return true;
		}
		insn_5:
		/* ANDI */
		if((insn & 0xFC000000) == 0x30000000) {
			...
			var temp_95 = rt;
			if(temp_95 != 0)
				State->Registers[temp_95] = (uint) ((((uint) (temp_8)) & ((uint) ((uint) ((ushort) (imm))))));
			return true;
		}
		insn_6:
		/* BEQ */
		if((insn & 0xFC000000) == 0x10000000) {
			...
			DoLds();
			if((bool) (((uint) (temp_9)) == ((uint) (temp_10)))) {
				Branch(target);
			} else {
		...
		if((insn & 0xFC110000) == 0x04010000) {
			...
			DoLds();
			if((bool) (((int) ((int) ((int) (temp_11)))) >= ((int) ((sbyte) ((byte) ((byte) 0x0)))))) {
				Branch(target);
			} else {
				Branch((uint) (((uint) (uint) ((uint) (pc))) + ((uint) (byte) ((byte) 0x8))));
			}
		...
		if((insn & 0xFC110000) == 0x04110000) {
			...
			if((bool) (((int) ((int) ((int) (temp_12)))) >= ((int) ((sbyte) ((byte) ((byte) 0x0)))))) {
				Branch(target);
			} else {
				Branch((uint) (((uint) (uint) ((uint) (pc))) + ((uint) (byte) ((byte) 0x8))));
			}
		...
		if((insn & 0xFC1F0000) == 0x1C000000) {
			...
			DoLds();
			if((bool) (((int) ((int) ((int) (temp_13)))) > ((int) ((sbyte) ((byte) ((byte) 0x0)))))) {
				Branch(target);
			} else {
				Branch((uint) (((uint) (uint) ((uint) (pc))) + ((uint) (byte) ((byte) 0x8))));
			}
		...
		if((insn & 0xFC1F0000) == 0x18000000) {
			...
			DoLds();
			if((bool) (((int) ((int) ((int) (temp_14)))) <= ((int) ((sbyte) ((byte) ((byte) 0x0)))))) {
				Branch(target);
			} else {
				Branch((uint) (((uint) (uint) ((uint) (pc))) + ((uint) (byte) ((byte) 0x8))));
			}
		...
		if((insn & 0xFC110000) == 0x04000000) {
			...
			DoLds();
			if((bool) (((int) ((int) ((int) (temp_15)))) < ((int) ((sbyte) ((byte) ((byte) 0x0)))))) {
				Branch(target);
			} else {
				Branch((uint) (((uint) (uint) ((uint) (pc))) + ((uint) (byte) ((byte) 0x8))));
			}
		...
		if((insn & 0xFC110000) == 0x04100000) {
			...
			DoLds();
			State->Registers[31] = (uint) (((uint) (uint) ((uint) (pc))) + ((uint) (byte) ((byte) 0x8)));
			if((bool) (((int) ((int) ((int) (temp_16)))) < ((int) ((sbyte) ((byte) ((byte) 0x0)))))) {
				Branch(target);
			} else {
				Branch((uint) (((uint) (uint) ((uint) (pc))) + ((uint) (byte) ((byte) 0x8))));
			}
		...
		if((insn & 0xFC000000) == 0x14000000) {
			...
			DoLds();
			if((bool) (((uint) (temp_17)) != ((uint) (temp_18)))) {
				Branch(target);
			} else {
				Branch((uint) (((uint) (uint) ((uint) (pc))) + ((uint) (byte) ((byte) 0x8))));
			}
		...
		if((insn & 0xFC00003F) == 0x0000001A) {
			...
			var rsv = temp_20;
			var rtv = temp_21;
			if((bool) (((uint) (rtv)) == ((uint) ((byte) ((byte) 0x0))))) {
				State->Lo = (uint) ((uint) ((byte) (((bool) (((uint) ((uint) ((((uint) (rsv)) & ((uint) (0x80000000U)))))) != ((uint) ((byte) ((byte) 0x0))))) ? (uint) ((byte) 0x1) : (uint) (0xFFFFFFFFU))));
				State->Hi = rsv;
			} else {
				if((bool) ((((bool) ((bool) (((uint) (rsv)) == ((uint) (0x80000000U))))) & ((bool) ((bool) (((uint) (rtv)) == ((uint) (0xFFFFFFFFU)))))))) {
		...
		if((insn & 0xFC00003F) == 0x0000001B) {
			...
			if((bool) (((uint) (rtv)) == ((uint) ((byte) ((byte) 0x0))))) {
				...
				State->Lo = (uint) (((uint) (uint) ((uint) (rsv))) / ((uint) (uint) ((uint) (rtv))));
				State->Hi = (uint) (((uint) (uint) ((uint) (rsv))) % ((uint) (uint) ((uint) (rtv))));
				DivDelay();
			}
			return true;
		}
		...
		if((insn & 0xFC00003F) == 0x00000009) {
			...
			var temp_113 = rd;
			if(temp_113 != 0)
				State->Registers[temp_113] = (uint) (((uint) (uint) ((uint) (pc))) + ((uint) (byte) ((byte) 0x8)));
			if((bool) (((uint) ((byte) ((byte) 0x0))) != ((uint) ((uint) ((((uint) (target)) & ((uint) ((uint) (((uint) (uint) ((uint) (((uint) (int) ((int) (32))) / ((uint) (byte) ((byte) 0x8))))) - ((uint) (byte) ((byte) 0x1))))))))))) {
		...
		if((insn & 0xFC000000) == 0x84000000) {
			...
			if((bool) (((uint) ((byte) ((byte) 0x0))) != ((uint) ((uint) ((((uint) (addr)) & ((uint) ((uint) (((uint) (uint) ((uint) (((uint) (int) ((int) (16))) / ((uint) (byte) ((byte) 0x8))))) - ((uint) (byte) ((byte) 0x1))))))))))) {
				throw new CpuException(ExceptionType.ADEL, pc, insn);
			}
			State->LdWhich = (uint) (rt);
		...
		if((insn & 0xFC000000) == 0x3C000000) {
			...
			var temp_119 = rt;
			if(temp_119 != 0)
				State->Registers[temp_119] = (uint) (((uint) ((uint) (imm))) << (int) ((byte) 0x10));
			return true;
		}
		insn_29:
		/* LW */
		if((insn & 0xFC000000) == 0x8C000000) {
			...
			if((bool) (((uint) ((byte) ((byte) 0x0))) != ((uint) ((uint) ((((uint) (addr)) & ((uint) ((uint) (((uint) (uint) ((uint) (((uint) (int) ((int) (32))) / ((uint) (byte) ((byte) 0x8))))) - ((uint) (byte) ((byte) 0x1))))))))))) {
				throw new CpuException(ExceptionType.ADEL, pc, insn);
			}
			State->LdWhich = (uint) (rt);
		...
		if((insn & 0xFC000000) == 0x88000000) {
			...
			var ert = temp_31;
			State->LdWhich = (uint) (rt);
			State->LdValue = (uint) ((uint) ((uint) ((((uint) (addr)) & ((uint) ((uint) ((byte) ((byte) 0x3)))))) switch { (uint) ((byte) 0x0) => (uint) ((((uint) ((uint) ((((uint) (ert)) & ((uint) (0xFFFFFFU)))))) | ((uint) ((uint) (((uint) ((uint) ((byte) (ReadMemory<byte>(raddr))))) << (int) ((byte) 0x18)))))), (uint) ((byte) 0x1) => (uint) ((((uint) ((uint) ((((uint) (ert)) & ((uint) ((uint) ((ushort) ((ushort) 0xFFFF)))))))) | ((uint) ((uint) (((uint) ((uint) ((ushort) (ReadMemory<ushort>(raddr))))) << (int) ((byte) 0x10)))))), (uint) ((byte) 0x2) => (uint) ((((uint) ((uint) ((((uint) (ert)) & ((uint) ((uint) ((byte) ((byte) 0xFF)))))))) | ((uint) ((uint) (((uint) (ReadMemory<uint>(raddr))) << (int) ((byte) 0x8)))))), _ => (uint) ((uint) (ReadMemory<uint>(raddr))) }));
			return true;
		}
		insn_31:
		/* LWR */
		if((insn & 0xFC000000) == 0x98000000) {
			...
			var ert = temp_33;
			State->LdWhich = (uint) (rt);
			State->LdValue = (uint) ((uint) ((uint) ((((uint) (addr)) & ((uint) ((uint) ((byte) ((byte) 0x3)))))) switch { (uint) ((byte) 0x0) => (uint) (ReadMemory<uint>(raddr)), (uint) ((byte) 0x1) => (uint) ((uint) ((((uint) ((uint) ((((uint) (ert)) & ((uint) (0xFF000000U)))))) | ((uint) ((uint) ((((uint) ((uint) (ReadMemory<uint>(addr)))) & ((uint) (0xFFFFFFU))))))))), (uint) ((byte) 0x2) => (uint) ((uint) ((((uint) ((uint) ((((uint) (ert)) & ((uint) (0xFFFF0000U)))))) | ((uint) ((uint) ((ushort) ((ushort) (ReadMemory<ushort>(addr))))))))), _ => (uint) ((uint) ((((uint) ((uint) ((((uint) (ert)) & ((uint) (0xFFFFFF00U)))))) | ((uint) ((uint) ((byte) ((byte) (ReadMemory<byte>(addr))))))))) }));
			return true;
		}
		insn_32:
		/* LWC2 */
		...
		if((insn & 0xFC00003F) == 0x00000010) {
			...
			var temp_128 = rd;
			if(temp_128 != 0)
				State->Registers[temp_128] = (uint) (State->Hi);
			AbsorbMuldivDelay();
			return true;
		}
		insn_35:
		...
		if((insn & 0xFC00003F) == 0x00000012) {
			...
			var temp_129 = rd;
			if(temp_129 != 0)
				State->Registers[temp_129] = (uint) (State->Lo);
			AbsorbMuldivDelay();
			return true;
		}
		insn_36:
		...
		if((insn & 0xFC00003F) == 0x00000027) {
			...
			var temp_139 = rd;
			if(temp_139 != 0)
				State->Registers[temp_139] = (uint) (~((uint) ((((uint) (temp_43)) | ((uint) (temp_44))))));
			return true;
		}
		insn_42:
		/* OR */
		if((insn & 0xFC00003F) == 0x00000025) {
			...
			var temp_142 = rd;
			if(temp_142 != 0)
				State->Registers[temp_142] = (uint) ((((uint) (temp_45)) | ((uint) (temp_46))));
			return true;
		}
		insn_43:
		/* ORI */
		if((insn & 0xFC000000) == 0x34000000) {
			...
			var temp_144 = rt;
			if(temp_144 != 0)
				State->Registers[temp_144] = (uint) ((((uint) (temp_47)) | ((uint) ((uint) ((uint) (imm))))));
			return true;
		}
		insn_44:
		/* SB */
		...
		if((insn & 0xFC00003F) == 0x00000000) {
			...
			var temp_150 = rd;
			if(temp_150 != 0)
				State->Registers[temp_150] = (uint) ((temp_52) << (int) (shamt));
			return true;
		}
		insn_47:
		/* SLLV */
		if((insn & 0xFC00003F) == 0x00000004) {
			...
			var temp_153 = rd;
			if(temp_153 != 0)
				State->Registers[temp_153] = (uint) ((temp_53) << (int) (temp_54));
			return true;
		}
		insn_48:
		/* SLT */
		...
		if((insn & 0xFC00003F) == 0x00000002) {
			...
			var temp_170 = rd;
			if(temp_170 != 0)
				State->Registers[temp_170] = (uint) ((temp_64) >> (int) (shamt));
			return true;
		}
		insn_55:
		/* SRLV */
		if((insn & 0xFC00003F) == 0x00000006) {
			...
			var temp_173 = rd;
			if(temp_173 != 0)
				State->Registers[temp_173] = (uint) ((temp_65) >> (int) (temp_66));
			return true;
		}
		insn_56:
		/* SUB */
		if((insn & 0xFC00003F) == 0x00000022) {
			...
			var rhs = temp_68;
			var r = (uint) ((uint) (((uint) (uint) ((uint) (lhs))) - ((uint) (uint) ((uint) (rhs)))));
			if((bool) (((uint) ((uint) (((((uint) ((uint) ((((uint) (lhs)) ^ ((uint) (rhs)))))) & ((uint) ((uint) ((((uint) (lhs)) ^ ((uint) (r))))))) & ((uint) (0x80000000U)))))) != ((uint) (0x0U)))) {
				throw new CpuException(ExceptionType.OV, pc, insn);
			}
			var temp_176 = rd;
			if(temp_176 != 0)
				State->Registers[temp_176] = (uint) (((uint) (uint) ((uint) (lhs))) - ((uint) (uint) ((uint) (rhs))));
			return true;
		}
		insn_57:
		/* SUBU */
		if((insn & 0xFC00003F) == 0x00000023) {
			...
			var temp_179 = rd;
			if(temp_179 != 0)
				State->Registers[temp_179] = (uint) (((uint) (uint) ((uint) (temp_69))) - ((uint) (uint) ((uint) (temp_70))));
			return true;
		}
		insn_58:
		/* SW */
		...
		if((insn & 0xFC000000) == 0xA8000000) {
			...
			var raddr = (uint) ((((uint) (addr)) & ((uint) (0xFFFFFFFCU))));
			var rtv = temp_75;
			switch((uint) ((((uint) (addr)) & ((uint) ((uint) ((byte) ((byte) 0x3))))))) {
				case (uint) ((byte) 0x0): {
		...
		if((insn & 0xFC00003F) == 0x00000026) {
			...
			var temp_189 = rd;
			if(temp_189 != 0)
				State->Registers[temp_189] = (uint) ((((uint) (temp_78)) ^ ((uint) (temp_79))));
			return true;
		}
		insn_64:
		/* XORI */
		if((insn & 0xFC000000) == 0x38000000) {
			...
			var temp_191 = rt;
			if(temp_191 != 0)
				State->Registers[temp_191] = (uint) ((((uint) (temp_80)) ^ ((uint) ((uint) ((uint) (imm))))));
			return true;
		}
		insn_65:

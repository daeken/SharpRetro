...
void setupHooks(const hookRegister_t regFunc) {
    ...
    hook("_ZN2nn2vi11CreateLayerEPPNS0_5LayerEPNS0_7DisplayEii", nn::vi::CreateLayerExtra);
    hook("_ZN2nn2vi12SetLayerCropEPNS0_5LayerEiiii", nn::vi::SetLayerCrop);
    ...
    hook("_ZN2nn2vi6native18NativeWindowHolder15GetNativeWindowEv", nn::vi::native::NativeWindowHolder::GetNativeWindow);

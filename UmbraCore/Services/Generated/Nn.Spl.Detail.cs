...
public abstract class _ICryptoInterface_Base : IpcInterface {
	...
	protected virtual void Unknown15(Span<byte> _0, Span<byte> _1) =>
...
public abstract class _IEsInterface_Base : IpcInterface {
	...
	protected virtual void Unknown13(Span<byte> _0, Span<byte> _1) =>
	...
	protected virtual void Unknown18(Span<byte> _0, Span<byte> _1, Span<byte> _2, Span<byte> _3) =>
...
public abstract class _IGeneralInterface_Base : IpcInterface {
	...
	protected virtual void GenerateAesKey(Span<byte> _0) =>
	...
	protected virtual void GetRandomBytes() =>
	...
	protected virtual void UnwrapRsaOaepWrappedTitleKey(Span<byte> _0, Span<byte> _1, Span<byte> _2, Span<byte> _3) =>
	...
	protected virtual void GetSharedData() =>

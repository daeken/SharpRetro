...
public abstract class _IManager_Base : IpcInterface {
	protected virtual void RegisterClassDriver(Span<byte> _0, KObject _1, out KObject _2, out Nn.Pcie.Detail.ISession _3) =>
		throw new NotImplementedException("Nn.Pcie.Detail.IManager.RegisterClassDriver not implemented");
	protected virtual void QueryFunctionsUnregistered(Span<byte> _0, Span<byte> _1) =>
...
public abstract class _ISession_Base : IpcInterface {
	protected virtual void QueryFunctions(Span<byte> _0, Span<byte> _1) =>
	...
	protected virtual void GetFunctionState(Span<byte> _0, Span<byte> _1) =>
		throw new NotImplementedException("Nn.Pcie.Detail.ISession.GetFunctionState not implemented");
	protected virtual void GetBarProfile(Span<byte> _0, Span<byte> _1) =>
		throw new NotImplementedException("Nn.Pcie.Detail.ISession.GetBarProfile not implemented");
	protected virtual void ReadConfig(Span<byte> _0, Span<byte> _1) =>
	...
	protected virtual void ReadBarRegion(Span<byte> _0, Span<byte> _1) =>
	...
	protected virtual void FindCapability(Span<byte> _0, Span<byte> _1) =>
		throw new NotImplementedException("Nn.Pcie.Detail.ISession.FindCapability not implemented");
	protected virtual void FindExtendedCapability(Span<byte> _0, Span<byte> _1) =>
		throw new NotImplementedException("Nn.Pcie.Detail.ISession.FindExtendedCapability not implemented");
	protected virtual void MapDma(Span<byte> _0, Span<byte> _1) =>
	...
	protected virtual void GetDmaBusAddress(Span<byte> _0, Span<byte> _1) =>
		throw new NotImplementedException("Nn.Pcie.Detail.ISession.GetDmaBusAddress not implemented");
	protected virtual void GetDmaBusAddressRange(Span<byte> _0, Span<byte> _1) =>

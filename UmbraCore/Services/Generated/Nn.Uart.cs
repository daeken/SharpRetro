...
public abstract class _IManager_Base : IpcInterface {
	...
	protected virtual void IsSomethingUartValid2(Span<byte> _0, Span<byte> _1) =>
		throw new NotImplementedException("Nn.Uart.IManager.IsSomethingUartValid2 not implemented");
	protected virtual void IsSomethingUartValid2ForTest(Span<byte> _0, Span<byte> _1) =>
...
public abstract class _IPortSession_Base : IpcInterface {
	protected virtual void OpenSession(Span<byte> _0, KObject _1, KObject _2, Span<byte> _3) =>
		throw new NotImplementedException("Nn.Uart.IPortSession.OpenSession not implemented");
	protected virtual void OpenSessionForTest(Span<byte> _0, KObject _1, KObject _2, Span<byte> _3) =>
	...
	protected virtual void Unknown6(Span<byte> _0, Span<byte> _1, out KObject _2) =>

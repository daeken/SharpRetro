...
public abstract class _ISystemServer_Base : IpcInterface {
	protected virtual void GetDataFormat(Span<byte> _0, Span<byte> _1) =>
	...
	protected virtual void GetMcuState(Span<byte> _0, Span<byte> _1) =>
	...
	protected virtual void GetMcuVersionForNfc(Span<byte> _0, Span<byte> _1) =>
	...
	protected virtual void SetNfcEvent(Span<byte> _0, out KObject _1, out KObject _2) =>
		throw new NotImplementedException("Nn.Xcd.Detail.ISystemServer.SetNfcEvent not implemented");
	protected virtual void GetNfcInfo(Span<byte> _0, Span<byte> _1) =>
	...
	protected virtual void GetAwakeTriggerReasonForLeftRail(Span<byte> _0) =>
		throw new NotImplementedException("Nn.Xcd.Detail.ISystemServer.GetAwakeTriggerReasonForLeftRail not implemented");
	protected virtual void GetAwakeTriggerReasonForRightRail(Span<byte> _0) =>

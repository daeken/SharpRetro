...
public abstract class _IBoardPowerControlManager_Base : IpcInterface {
	...
	protected virtual void GetSleepButtonState(Span<byte> _0) =>
	...
	protected virtual void Unknown8(Span<byte> _0, Span<byte> _1) =>
...
public abstract class _IRtcManager_Base : IpcInterface {
	protected virtual void GetExternalRtcValue(Span<byte> _0) =>
	...
	protected virtual void ReadExternalRtcResetFlag(Span<byte> _0) =>

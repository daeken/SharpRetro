...
public abstract class _IClientEpSession_Base : IpcInterface {
	...
	protected virtual void PostBufferAsync(Span<byte> _0) =>
...
public abstract class _IClientIfSession_Base : IpcInterface {
	...
	protected virtual void GetCtrlXferReport() =>
	...
	protected virtual void GetClientEpSession(Span<byte> _0) =>
...
public abstract class _IClientRootSession_Base : IpcInterface {
	...
	protected virtual void GetClientIfSession(Span<byte> _0) =>

...
public abstract class _INetworkInstallManager_Base : IpcInterface {
	protected virtual void CreateSystemUpdateTask(Span<byte> _0, Span<byte> _1) =>
	...
	protected virtual void ListSystemUpdateTask(Span<byte> _0, Span<byte> _1) =>
		throw new NotImplementedException("Nn.Nim.Detail.INetworkInstallManager.ListSystemUpdateTask not implemented");
	protected virtual void RequestSystemUpdateTaskRun(Span<byte> _0, out KObject _1, out Nn.Nim.Detail.IAsyncResult _2) =>
		throw new NotImplementedException("Nn.Nim.Detail.INetworkInstallManager.RequestSystemUpdateTaskRun not implemented");
	protected virtual void GetSystemUpdateTaskInfo(Span<byte> _0, Span<byte> _1) =>
	...
	protected virtual void CreateNetworkInstallTask(Span<byte> _0, Span<byte> _1, Span<byte> _2) =>
	...
	protected virtual void ListNetworkInstallTask(Span<byte> _0, Span<byte> _1) =>
		throw new NotImplementedException("Nn.Nim.Detail.INetworkInstallManager.ListNetworkInstallTask not implemented");
	protected virtual void RequestNetworkInstallTaskRun(Span<byte> _0, out KObject _1, out Nn.Nim.Detail.IAsyncResult _2) =>
		throw new NotImplementedException("Nn.Nim.Detail.INetworkInstallManager.RequestNetworkInstallTaskRun not implemented");
	protected virtual void GetNetworkInstallTaskInfo(Span<byte> _0, Span<byte> _1) =>
	...
	protected virtual void ListApplicationNetworkInstallTask(Span<byte> _0, Span<byte> _1, Span<byte> _2) =>
		throw new NotImplementedException("Nn.Nim.Detail.INetworkInstallManager.ListApplicationNetworkInstallTask not implemented");
	protected virtual void ListNetworkInstallTaskContentMeta(Span<byte> _0, Span<byte> _1, Span<byte> _2) =>
		throw new NotImplementedException("Nn.Nim.Detail.INetworkInstallManager.ListNetworkInstallTaskContentMeta not implemented");
	protected virtual void RequestLatestVersion(Span<byte> _0, out KObject _1, out Nn.Nim.Detail.IAsyncValue _2) =>
	...
	protected virtual void GetDownloadedSystemDataPath(Span<byte> _0, Span<byte> _1) =>
		throw new NotImplementedException("Nn.Nim.Detail.INetworkInstallManager.GetDownloadedSystemDataPath not implemented");
	protected virtual void CalculateNetworkInstallTaskRequiredSize(Span<byte> _0, Span<byte> _1) =>
	...
	protected virtual void IsExFatDriverIncluded(Span<byte> _0, Span<byte> _1) =>
	...
	protected virtual void RequestGameCardRegistrationStatus(Span<byte> _0, Span<byte> _1, Span<byte> _2, out KObject _3, out Nn.Nim.Detail.IAsyncValue _4) =>
		throw new NotImplementedException("Nn.Nim.Detail.INetworkInstallManager.RequestGameCardRegistrationStatus not implemented");
	protected virtual void RequestRegisterGameCard(Span<byte> _0, Span<byte> _1, Span<byte> _2, out KObject _3, out Nn.Nim.Detail.IAsyncResult _4) =>
		throw new NotImplementedException("Nn.Nim.Detail.INetworkInstallManager.RequestRegisterGameCard not implemented");
	protected virtual void RequestRegisterNotificationToken(Span<byte> _0, out KObject _1, out Nn.Nim.Detail.IAsyncResult _2) =>
		throw new NotImplementedException("Nn.Nim.Detail.INetworkInstallManager.RequestRegisterNotificationToken not implemented");
	protected virtual void RequestDownloadTaskList(Span<byte> _0, out KObject _1, out Nn.Nim.Detail.IAsyncData _2) =>
		throw new NotImplementedException("Nn.Nim.Detail.INetworkInstallManager.RequestDownloadTaskList not implemented");
	protected virtual void RequestApplicationControl(Span<byte> _0, out KObject _1, out Nn.Nim.Detail.IAsyncValue _2) =>
		throw new NotImplementedException("Nn.Nim.Detail.INetworkInstallManager.RequestApplicationControl not implemented");
	protected virtual void RequestLatestApplicationControl(Span<byte> _0, out KObject _1, out Nn.Nim.Detail.IAsyncValue _2) =>
		throw new NotImplementedException("Nn.Nim.Detail.INetworkInstallManager.RequestLatestApplicationControl not implemented");
	protected virtual void RequestVersionList(Span<byte> _0, out KObject _1, out Nn.Nim.Detail.IAsyncData _2) =>
		throw new NotImplementedException("Nn.Nim.Detail.INetworkInstallManager.RequestVersionList not implemented");
	protected virtual void CreateApplyDeltaTask(Span<byte> _0, Span<byte> _1, Span<byte> _2) =>
	...
	protected virtual void ListApplicationApplyDeltaTask(Span<byte> _0, Span<byte> _1, Span<byte> _2) =>
		throw new NotImplementedException("Nn.Nim.Detail.INetworkInstallManager.ListApplicationApplyDeltaTask not implemented");
	protected virtual void RequestApplyDeltaTaskRun(Span<byte> _0, out KObject _1, out Nn.Nim.Detail.IAsyncResult _2) =>
		throw new NotImplementedException("Nn.Nim.Detail.INetworkInstallManager.RequestApplyDeltaTaskRun not implemented");
	protected virtual void GetApplyDeltaTaskInfo(Span<byte> _0, Span<byte> _1) =>
		throw new NotImplementedException("Nn.Nim.Detail.INetworkInstallManager.GetApplyDeltaTaskInfo not implemented");
	protected virtual void ListApplyDeltaTask(Span<byte> _0, Span<byte> _1, Span<byte> _2) =>
	...
	protected virtual void CalculateApplyDeltaTaskRequiredSize(Span<byte> _0, Span<byte> _1) =>
	...
	protected virtual void ListApplyDeltaTask2(Span<byte> _0, Span<byte> _1) =>
...
public abstract class _IShopServiceManager_Base : IpcInterface {
	...
	protected virtual void RequestCachedDeviceAuthenticationToken(Span<byte> _0, out KObject _1, out Nn.Nim.Detail.IAsyncValue _2) =>
	...
	protected virtual void GetDeviceAccountInfo(Span<byte> _0) =>
	...
	protected virtual void IsOwnDeviceId(Span<byte> _0, Span<byte> _1) =>
	...
	protected virtual void RequestUnlinkDevice(Span<byte> _0, out KObject _1, out Nn.Nim.Detail.IAsyncResult _2) =>
		throw new NotImplementedException("Nn.Nim.Detail.IShopServiceManager.RequestUnlinkDevice not implemented");
	protected virtual void RequestUnlinkDeviceIntegrated(Span<byte> _0, out KObject _1, out Nn.Nim.Detail.IAsyncResult _2) =>
		throw new NotImplementedException("Nn.Nim.Detail.IShopServiceManager.RequestUnlinkDeviceIntegrated not implemented");
	protected virtual void RequestLinkDevice(Span<byte> _0, out KObject _1, out Nn.Nim.Detail.IAsyncResult _2) =>
		throw new NotImplementedException("Nn.Nim.Detail.IShopServiceManager.RequestLinkDevice not implemented");
	protected virtual void HasDeviceLink(Span<byte> _0, Span<byte> _1) =>
	...
	protected virtual void RequestCreateVirtualAccount(Span<byte> _0, out KObject _1, out Nn.Nim.Detail.IAsyncResult _2) =>
		throw new NotImplementedException("Nn.Nim.Detail.IShopServiceManager.RequestCreateVirtualAccount not implemented");
	protected virtual void RequestDeviceLinkStatus(Span<byte> _0, out KObject _1, out Nn.Nim.Detail.IAsyncValue _2) =>
		throw new NotImplementedException("Nn.Nim.Detail.IShopServiceManager.RequestDeviceLinkStatus not implemented");
	protected virtual void GetAccountByVirtualAccount(Span<byte> _0, Span<byte> _1) =>
	...
	protected virtual void RequestDownloadTicket(Span<byte> _0, out KObject _1, out Nn.Nim.Detail.IAsyncResult _2) =>
		throw new NotImplementedException("Nn.Nim.Detail.IShopServiceManager.RequestDownloadTicket not implemented");
	protected virtual void RequestDownloadTicketForPrepurchasedContents(Span<byte> _0, out KObject _1, out Nn.Nim.Detail.IAsyncValue _2) =>

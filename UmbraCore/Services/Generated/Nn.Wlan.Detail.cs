...
public abstract class _IInfraManager_Base : IpcInterface {
	protected virtual void Unknown0() =>
		"Stub hit for Nn.Wlan.Detail.IInfraManager.Unknown0".Log();
	protected virtual void Unknown1() =>
		"Stub hit for Nn.Wlan.Detail.IInfraManager.Unknown1".Log();
	...
	protected virtual void StartScan(Span<byte> _0) =>
		"Stub hit for Nn.Wlan.Detail.IInfraManager.StartScan".Log();
	protected virtual void StopScan() =>
		"Stub hit for Nn.Wlan.Detail.IInfraManager.StopScan".Log();
	protected virtual void Connect(byte[] _0) =>
		"Stub hit for Nn.Wlan.Detail.IInfraManager.Connect".Log();
	protected virtual void CancelConnect() =>
		"Stub hit for Nn.Wlan.Detail.IInfraManager.CancelConnect".Log();
	protected virtual void Disconnect() =>
		"Stub hit for Nn.Wlan.Detail.IInfraManager.Disconnect".Log();
	...
	protected virtual void ChangeRxAntenna(byte[] _0) =>
		"Stub hit for Nn.Wlan.Detail.IInfraManager.ChangeRxAntenna".Log();
	...
	protected virtual void Unknown15() =>
		"Stub hit for Nn.Wlan.Detail.IInfraManager.Unknown15".Log();
	protected virtual void RequestWakeUp() =>
		"Stub hit for Nn.Wlan.Detail.IInfraManager.RequestWakeUp".Log();
	protected virtual void RequestIfUpDown(byte[] _0, Span<byte> _1) =>
		"Stub hit for Nn.Wlan.Detail.IInfraManager.RequestIfUpDown".Log();
	...
	protected virtual void Unknown19(byte[] _0) =>
		"Stub hit for Nn.Wlan.Detail.IInfraManager.Unknown19".Log();
	protected virtual void Unknown20() =>
		"Stub hit for Nn.Wlan.Detail.IInfraManager.Unknown20".Log();
	...
	protected virtual void Unknown22(byte[] _0) =>
		"Stub hit for Nn.Wlan.Detail.IInfraManager.Unknown22".Log();
	protected virtual void Unknown23(byte[] _0) =>
		"Stub hit for Nn.Wlan.Detail.IInfraManager.Unknown23".Log();
	...
	protected virtual void Unknown25(byte[] _0) =>
		"Stub hit for Nn.Wlan.Detail.IInfraManager.Unknown25".Log();
	protected virtual void Unknown26() =>
		"Stub hit for Nn.Wlan.Detail.IInfraManager.Unknown26".Log();
	protected virtual void Unknown27() =>
		"Stub hit for Nn.Wlan.Detail.IInfraManager.Unknown27".Log();
...
public abstract class _ILocalManager_Base : IpcInterface {
	protected virtual void Unknown0() =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.Unknown0".Log();
	protected virtual void Unknown1() =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.Unknown1".Log();
	protected virtual void Unknown2() =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.Unknown2".Log();
	protected virtual void Unknown3() =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.Unknown3".Log();
	protected virtual void Unknown4() =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.Unknown4".Log();
	protected virtual void Unknown5() =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.Unknown5".Log();
	protected virtual void GetMacAddress(out byte[] _0) =>
	...
	protected virtual void CreateBss(byte[] _0) =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.CreateBss".Log();
	protected virtual void DestroyBss() =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.DestroyBss".Log();
	protected virtual void StartScan(Span<byte> _0) =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.StartScan".Log();
	protected virtual void StopScan() =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.StopScan".Log();
	protected virtual void Connect(byte[] _0) =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.Connect".Log();
	protected virtual void CancelConnect() =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.CancelConnect".Log();
	protected virtual void Join(byte[] _0) =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.Join".Log();
	protected virtual void CancelJoin() =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.CancelJoin".Log();
	protected virtual void Disconnect(byte[] _0) =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.Disconnect".Log();
	protected virtual void SetBeaconLostCount(byte[] _0) =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.SetBeaconLostCount".Log();
	...
	protected virtual void DeleteIe(byte[] _0) =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.DeleteIe".Log();
	protected virtual void Unknown26(Span<byte> _0) =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.Unknown26".Log();
	protected virtual void Unknown27(byte[] _0) =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.Unknown27".Log();
	...
	protected virtual void DeleteRxEntry(byte[] _0) =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.DeleteRxEntry".Log();
	protected virtual void Unknown30(byte[] _0) =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.Unknown30".Log();
	...
	protected virtual void AddMatchingDataToRxEntry(byte[] _0, Span<byte> _1) =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.AddMatchingDataToRxEntry".Log();
	protected virtual void RemoveMatchingDataFromRxEntry(byte[] _0, Span<byte> _1) =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.RemoveMatchingDataFromRxEntry".Log();
	...
	protected virtual void Unknown35(byte[] _0, Span<byte> _1) =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.Unknown35".Log();
	protected virtual void SetActionFrameWithBeacon(Span<byte> _0) =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.SetActionFrameWithBeacon".Log();
	protected virtual void CancelActionFrameWithBeacon() =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.CancelActionFrameWithBeacon".Log();
	...
	protected virtual void DeleteRxEntryForActionFrame(byte[] _0) =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.DeleteRxEntryForActionFrame".Log();
	protected virtual void Unknown40(byte[] _0) =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.Unknown40".Log();
	...
	protected virtual void CancelGetActionFrame(byte[] _0) =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.CancelGetActionFrame".Log();
	protected virtual void GetRssi(out byte[] _0) =>
	...
	protected virtual void Unknown44(byte[] _0) =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.Unknown44".Log();
	protected virtual void Unknown45() =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.Unknown45".Log();
	protected virtual void Unknown46() =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.Unknown46".Log();
	protected virtual void Unknown47() =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.Unknown47".Log();
	protected virtual void Unknown48() =>
		"Stub hit for Nn.Wlan.Detail.ILocalManager.Unknown48".Log();
	protected override unsafe void _Dispatch(IncomingMessage im, OutgoingMessage om) {
		switch(im.CommandId) {
			case 0x0: { // Unknown0
				Unknown0();
...
public abstract class _ISocketManager_Base : IpcInterface {
	protected virtual void Unknown0(Span<byte> _0) =>
		"Stub hit for Nn.Wlan.Detail.ISocketManager.Unknown0".Log();
	protected virtual void Unknown1(byte[] _0) =>
		"Stub hit for Nn.Wlan.Detail.ISocketManager.Unknown1".Log();
	...
	protected virtual void Unknown3(byte[] _0) =>
		"Stub hit for Nn.Wlan.Detail.ISocketManager.Unknown3".Log();
	protected virtual void Unknown4(byte[] _0) =>
		"Stub hit for Nn.Wlan.Detail.ISocketManager.Unknown4".Log();
	...
	protected virtual void SwitchTsfTimerFunction(byte[] _0) =>
		"Stub hit for Nn.Wlan.Detail.ISocketManager.SwitchTsfTimerFunction".Log();
	...
	protected virtual void Unknown9(byte[] _0, KObject _1, KObject _2, KObject _3, KObject _4, KObject _5) =>
		"Stub hit for Nn.Wlan.Detail.ISocketManager.Unknown9".Log();
	protected virtual void Unknown10() =>
		"Stub hit for Nn.Wlan.Detail.ISocketManager.Unknown10".Log();
	protected virtual void Unknown11() =>
		"Stub hit for Nn.Wlan.Detail.ISocketManager.Unknown11".Log();
	protected override unsafe void _Dispatch(IncomingMessage im, OutgoingMessage om) {
		switch(im.CommandId) {
			case 0x0: { // Unknown0

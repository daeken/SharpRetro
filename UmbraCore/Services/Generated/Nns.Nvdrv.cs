...
public abstract class _INvDrvDebugFSServices_Base : IpcInterface {
	protected virtual void OpenLog(KObject _0) =>
	...
	protected virtual void ReadLog(Span<byte> _0) =>
...
public abstract class _INvDrvServices_Base : IpcInterface {
	protected virtual void Open(Span<byte> path) =>
		throw new NotImplementedException("Nns.Nvdrv.INvDrvServices.Open not implemented");
	protected virtual void Ioctl(uint fd, uint rq_id, Span<byte> _2) =>
	...
	protected virtual void QueryEvent(uint fd, uint event_id) =>
	...
	protected virtual void Ioctl2(uint _0, uint _1, Span<byte> _2, Span<byte> _3) =>
		throw new NotImplementedException("Nns.Nvdrv.INvDrvServices.Ioctl2 not implemented");
	protected virtual void Ioctl3(uint _0, uint _1, Span<byte> _2) =>

...
public partial class IClient {
    protected override uint RegisterClient(BsdBufferConfig config, ulong pid,
        ...
        Console.WriteLine($"Nn.Socket.Sf.IClient.RegisterClient pid=0x{pid:X} transferMemorySize=0x{transferMemorySize:X} transferMemory=0x{transferMemory?.Handle} _4=0x{_4:X}");
        return 0;
    }
}

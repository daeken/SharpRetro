...
public unsafe delegate void SetupDelegate(CallbackTableOffsets* callbacks);
...
public unsafe class GameWrapper {
                    ...
                    case 1:
                        ...
                        switch(a) {
                            ...
                            case 0x07:
                                ...
                                break;
                            case 0x08:
                                state->X0 = Callbacks.CreateThread(state->X1, state->X2, state->X3, state->X4,
                                    state->X5,
                                    ref state->X1);
                                break;
                            case 0x09:
                                state->X0 = Callbacks.StartThread(state->X0);
                                break;
                            case 0x0A:
                            ...
                            case 0x14:
                                ...
                                break;
                            case 0x15:
                                state->X0 = Callbacks.CreateTransferMemory(state->X1, state->X2, state->X3,
                                    ref state->X1);
                                break;
                            case 0x16:
                            ...
                            case 0x17:
                                ...
                                break;
                            case 0x18:
                                state->X0 = Callbacks.WaitSynchronization(state->X1, state->X2, state->X3,
                                    ref state->X1);
                                break;
                            case 0x19:
                            ...
                            case 0x1B:
                                ...
                                break;
                            case 0x1C:
                                state->X0 = Callbacks.WaitProcessWideKeyAtomic(state->X0, state->X1, state->X2,
                                    state->X3);
                                break;
                            case 0x1D:
                            ...
                            case 0x4F:
                                ...
                                break;
                            case 0x50:
                                state->X0 = Callbacks.CreateSharedMemory(state->X1, state->X2, state->X3,
                                    ref state->X1);
                                break;
                            case 0x51:
                            ...
                            case 0x5B:
                                ...
                                break;
                            case 0x5C:
                                state->X0 = Callbacks.UnmapDeviceAddressSpace(state->X0, state->X1, state->X2,
                                    state->X3,
                                    state->X4);
                                break;
                            case 0x5D:
                            ...
                            case 0x69:
                                ...
                                break;
                            case 0x6A:
                                state->X0 = Callbacks.ReadDebugProcessMemory(state->X0, state->X1, state->X2,
                                    state->X3);
                                break;
                            case 0x6B:
                                state->X0 = Callbacks.WriteDebugProcessMemory(state->X0, state->X1, state->X2,
                                    state->X3);
                                break;
                            case 0x6C:
                                ...
                                break;
                            case 0x6D:
                                state->X0 = Callbacks.GetDebugThreadParam(state->X2, state->X3, state->X4,
                                    ref state->X1,
                                    ref state->X2);
                                break;
                            case 0x6F:
                            ...
                            case 0x75:
                                ...
                                break;
                            case 0x76:
                                state->X0 = Callbacks.QueryProcessMemory(state->X0, state->X2, state->X3,
                                    ref state->X1);
                                break;
                            case 0x77:
                                ...
                                break;
                            case 0x78:
                                state->X0 = Callbacks.UnmapProcessCodeMemory(state->X0, state->X1, state->X2,
                                    state->X3);
                                break;
                            case 0x79:
                            ...
                            case 0x7F:
                                state->X0 = Callbacks.CallSecureMonitor(state->X0, state->X1, state->X2, state->X3,
                                    state->X4, state->X5, state->X6, state->X7, ref state->X1, ref state->X2,
                                    ref state->X3,
	...
	public void Setup() => _Setup(Callbacks.CallbackTable);
...
public delegate ulong StartThreadDelegate(ulong in_0);
...
public unsafe class Callbacks {
    public readonly CallbackTableOffsets* CallbackTable =
        (CallbackTableOffsets*) Marshal.AllocHGlobal(sizeof(CallbackTableOffsets));
    ...
    } = _ => throw new NotImplementedException("StartThread not implemented");
